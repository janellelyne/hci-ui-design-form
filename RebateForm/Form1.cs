...
namespace RebateForm
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e) //save btn
        {
            ...
            if (string.IsNullOrWhiteSpace(contents[0]))
            ...
            else if (string.IsNullOrWhiteSpace(contents[1]) == true)
                MessageBox.Show("Last Name is required");
            else if (string.IsNullOrWhiteSpace(contents[8]) == true)
                MessageBox.Show("Phone Number is required.");
            else if (this.checkFullname())
                MessageBox.Show("Duplicate name entry. Enter new name.");
                ...
                MessageBox.Show("Invalid date. Enter valid date MM/DD/YYYY.  :)");
            else
            {
                if (!File.Exists("CS6326Asg2.txt"))
                {
        ...
        private void button2_Click(object sender, EventArgs e) //clear fields btn or new
        {
            this.ClearFields();
        ...
        private void button4_Click(object sender, EventArgs e)  //modify btn
        {
            if (listView1.SelectedItems.Count != 1)
